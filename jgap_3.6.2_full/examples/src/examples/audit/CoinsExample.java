...
//            eval.setValue(permutation,run,fitness, new Integer(0), s);
    ...
    FileOutputStream fo = new FileOutputStream(
        "/home/epes/workspace/jgap_3.6.2_full/JGAP_chart_fitness_values.png");
    //ChartUtilities.writeBufferedImageAsJPEG(fo, 0.7f, image);
    ChartUtilities.writeBufferedImageAsPNG(fo, image);
...
//      myDataset = eval.calcAvgFitness(i);
    ...
    fo = new FileOutputStream("/home/epes/workspace/jgap_3.6.2_full/JGAP_chart_fitness_values_1.png");
    //ChartUtilities.writeBufferedImageAsJPEG(fo, 0.7f, image);
    ChartUtilities.writeBufferedImageAsPNG(fo, image);
  }
