...
public class MaintenanceTaskGeneGCMulti extends MaintenanceTaskGene {
	...
	// Constructors
	public MaintenanceTaskGeneGCMulti(Configuration a_config, int duration, int durationSecondDay,
	...
	public MaintenanceTaskGeneGCMulti(Configuration a_config)
			throws InvalidConfigurationException {
		super(a_config);
	}
	
	public MaintenanceTaskGeneGCMulti(Configuration a_config, FixedBinaryGene a_toCopy)
			throws InvalidConfigurationException {
	...
	protected Gene newGeneInternal() {
		try {
			MaintenanceTaskGeneGCMulti result = new MaintenanceTaskGeneGCMulti(getConfiguration());
			return result;
